...
from datasets.k400 import K400Dataset_train, K400Dataset_val,K400Dataset_train_linear
from models.c3d import C3D
from models.r3d import R3DNet
from models.r21d import R2Plus1DNet
#sfrom models.s3d_g import S3D
...
def parse_args():
    ...
    parser.add_argument('--ckpt', type=str, default='log/UCF101_R3D50_TCG112_r3d_cl16_it8_tl3_12221043/best_acc_model_29.pt', help='checkpoint path')
    ...
    parser.add_argument('--output_dir', type=str, default='log/K400_Linear')
...
if __name__ == '__main__':
    ...
    if args.model == 'c3d':
        ...
        model = R3DNet(layer_sizes=(3,4,6,3), with_classifier=True, num_classes=class_num).cuda()
    ...
    if args.mode == 'train':  ########### Train #############
        ...
        if args.dataset == 'ucf101':
            ...
            train_dataset = K400Dataset_train_linear('data/K400', args.cl, args.split, True, test_transforms, 30)
            test_dataset = K400Dataset_train_linear('data/K400', args.cl, args.split, False, test_transforms, 30)
