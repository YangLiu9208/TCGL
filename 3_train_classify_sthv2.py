...
from datasets.k400 import K400Dataset_train, K400Dataset_val
from datasets.sthv2 import SthV2Dataset_train, SthV2Dataset_val
...
def parse_args():
    ...
    parser.add_argument('--ckpt', type=str, default='log/SthV2_TCG_finetuned_acc_r3d_cl16_06152143/best_model_12.pt', help='checkpoint path')
...
if __name__ == '__main__':
    ...
    if args.mode == 'train':  ########### Train #############
        ...
        if args.dataset == 'ucf101':
            ...
            train_dataset = SthV2Dataset_train("E:/Something-something-v2/20bn-something-something-v2", \
            "E:/Something-something-v2/annotations/something-something-v2-train.json", \
            "E:/Something-something-v2/annotations/something-something-v2-labels.json", args.cl, True, train_transforms)
            val_dataset = SthV2Dataset_val("E:/Something-something-v2/20bn-something-something-v2", \
        ...
        if args.dataset == 'ucf101':
            ...
            test_dataset = K400Dataset_train('data/K400', args.cl, args.split, False, test_transforms, 10)
        elif args.dataset == 'sthv2':
            test_dataset = SthV2Dataset_val("E:/Something-something-v2/20bn-something-something-v2", \
            "E:/Something-something-v2/annotations/something-something-v2-validation.json", \
            "E:/Something-something-v2/annotations/something-something-v2-labels.json", args.cl, False, test_transforms,10)
            #test_dataset = SthV2Dataset_train("E:/Something-something-v2/20bn-something-something-v2", \
            #"E:/Something-something-v2/annotations/something-something-v2-test.json", \
            #"E:/Something-something-v2/annotations/something-something-v2-labels.json", args.cl, False, test_transforms, is_test=True)
