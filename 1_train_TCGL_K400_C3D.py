...
from models.TCG import TCG_triple, TCG_triple_R3D_R21D, TCG_FourClip, TCG_FourClip_R3D_R21D,TCG_triple_S3D
...
def parse_args():
    ...
    parser.add_argument('--bs', type=int, default=28, help='mini-batch size')
...
if __name__ == '__main__':
    ...
    tcg = TCG_triple(base_network=base, feature_size=512, tuple_len=args.tl)
