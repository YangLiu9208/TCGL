...
class I3D(torch.nn.Module):
    def __init__(self,
                 ...
                 modality='rgb',
                 dropout_prob=0,
                 name='inception',with_classifier=False, return_conv=False):
        ...
        self.avg_pool = torch.nn.AvgPool3d((1, 4, 4), (1, 1, 1))
...
if __name__ == '__main__':
    model =  I3D(num_classes=101,modality='rgb',dropout_prob=0,name='inception', with_classifier=False, return_conv=False)
