...
def gen_ucf101_vcop_splits(root_dir, clip_len, interval, tuple_len):
    ...
    vcop_train_split_name = 'vcop_train_{}_{}_{}_quad.txt'.format(clip_len, interval, tuple_len)
    vcop_train_split_path = os.path.join(root_dir, 'split', vcop_train_split_name).replace('\\', '/')
    vcop_test_split_name = 'vcop_test_{}_{}_{}_quad.txt'.format(clip_len, interval, tuple_len)
    ...
    min_video_len = 4*clip_len * tuple_len + interval * (tuple_len - 1)
