...
from datasets.k400 import K400VCOPDataset_train,K400VCOPDataset_val
from models.c3d import C3D
from models.r3d import R3DNet
from models.r21d import R2Plus1DNet
from models.i3dv2 import I3D
...
from models.TCG import TCG_triple, TCG_triple_R3D_R21D, TCG_FourClip, TCG_FourClip_R3D_R21D,TCG_triple_S3D,TCG_triple_R3D_R21D_FCA
...
def parse_args():
    ...
    parser.add_argument('--model', type=str, default='r21d', help='c3d/r3d/r21d/s3d')
...
if __name__ == '__main__':
    ...
    if args.model == 'c3d':
        ...
        base = I3D(with_classifier=False).to(device)

    tcg = TCG_triple_R3D_R21D_FCA(base_network=base, feature_size=512, tuple_len=args.tl)
    ...
    if args.mode == 'train':  ########### Train #############
        if args.ckpt:  # resume training
            ...
            if args.desp:
                exp_name = 'K400_TCG_{}_cl{}_it{}_tl{}_{}_{}'.format(args.model, args.cl, args.it, args.tl, args.desp, time.strftime('%m%d%H%M'))
            else:
                exp_name = 'K400_TCG_{}_cl{}_it{}_tl{}_{}'.format(args.model, args.cl, args.it, args.tl, time.strftime('%m%d%H%M'))
            log_dir = os.path.join(args.log, exp_name)
        writer = SummaryWriter(log_dir)
        if torch.cuda.device_count() > 1:
            tcg = torch.nn.DataParallel(tcg, device_ids=[0,1,2,3]).cuda()
        ...
        train_dataset = K400VCOPDataset_train('data/K400', args.cl, args.it, args.tl, True, train_transforms)
        val_dataset = K400VCOPDataset_val('data/K400', args.cl, args.it, args.tl, True, train_transforms)
        ...
        test_dataset = K400VCOPDataset('data/K400', args.cl, args.it, args.tl, False, test_transforms)
