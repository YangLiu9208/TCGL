...
def parse_args():
    ...
    parser.add_argument('--ckpt', type=str, default='log/Frequency_3090/K400_TCG_r3d_cl16_it8_tl3_03281143/best_acc_model_216.pt', help='checkpoint path')
...
if __name__ == '__main__':
    ...
    if args.desp:
        exp_name = 'SthV2_TCG_finetuned_loss_{}_cl{}_{}_{}'.format(args.model, args.cl, args.desp, time.strftime('%m%d%H%M'))
    else:
        exp_name = 'SthV2_TCG_finetuned_loss_{}_cl{}_{}'.format(args.model, args.cl, time.strftime('%m%d%H%M'))
