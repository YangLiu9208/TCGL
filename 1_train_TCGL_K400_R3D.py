...
def parse_args():
    ...
    parser.add_argument('--model', type=str, default='r3d', help='c3d/r3d/r21d/i3d')
    ...
    parser.add_argument('--bs', type=int, default=40, help='mini-batch size')
...
if __name__ == '__main__':
    ...
    tcg = TCG_triple_R3D_R21D_FCA(base_network=base, feature_size=512, tuple_len=args.tl).cuda()
    ...
    if args.mode == 'train':  ########### Train #############
        if args.ckpt:  # resume training
            ...
            if args.desp:
                exp_name = 'K400_TCG_224_{}_cl{}_it{}_tl{}_{}_{}'.format(args.model, args.cl, args.it, args.tl, args.desp, time.strftime('%m%d%H%M'))
            else:
                exp_name = 'K400_TCG_224_{}_cl{}_it{}_tl{}_{}'.format(args.model, args.cl, args.it, args.tl, time.strftime('%m%d%H%M'))
